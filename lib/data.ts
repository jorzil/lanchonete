...
export const PRODUCTS: Product[] = [
  ...
  { id: 'fanta-laranja-lata',name: 'Fanta Laranja Lata 350ml',           description: 'Refrigerante Fanta Laranja gelado lata 350ml',           price: 8.0,  image: '🥤', imageUrl: '/bebidas/fanta-laranja.png',     category: 'bebidas', active: true },
  { id: 'fanta-uva-lata',    name: 'Fanta Uva 350ml',                    description: 'Refrigerante Fanta Uva gelado lata 350ml',               price: 8.0,  image: '🥤', imageUrl: '/bebidas/fanta-uva.png',         category: 'bebidas', active: true },
  { id: 'coca-600',          name: 'Coca-Cola 600ml',                    description: 'Refrigerante Coca-Cola garrafa 600ml',                   price: 11.0, image: '🥤', imageUrl: '/bebidas/coca-600.png',          category: 'bebidas', active: true },
  { id: 'coca-zero-600',     name: 'Coca-Cola Zero Açúcar 600ml',        description: 'Refrigerante Coca-Cola Zero Açúcar garrafa 600ml',       price: 11.0, image: '🥤', imageUrl: '/bebidas/coca-zero-600.png',     category: 'bebidas', active: true },
  { id: 'guarana-600',       name: 'Guaraná Antarctica 600ml',           description: 'Refrigerante Guaraná Antarctica garrafa 600ml',          price: 11.0, image: '🥤', imageUrl: '/bebidas/guarana-600.png',       category: 'bebidas', active: true },
  { id: 'guarana-zero-600',  name: 'Guaraná Antarctica Zero 600ml',      description: 'Refrigerante Guaraná Antarctica Zero garrafa 600ml',     price: 11.0, image: '🥤', imageUrl: '/bebidas/guarana-zero-600.png',  category: 'bebidas', active: true },
  { id: 'h2oh-limoneto',     name: 'H2OH Limoneto 500ml',                description: 'H2OH sabor Limoneto 500ml',                              price: 11.0, image: '🥤', imageUrl: '/bebidas/h2oh.png',              category: 'bebidas', active: true },
  { id: 'agua-sem-gas',      name: 'Água Mineral sem Gás 500ml',         description: 'Água mineral natural sem gás 500ml',                     price: 5.0,  image: '💧', imageUrl: '/bebidas/agua-sem-gas.png',      category: 'bebidas', active: true },
  { id: 'agua-com-gas',      name: 'Água Mineral com Gás 500ml',         description: 'Água mineral com gás 500ml',                             price: 5.0,  image: '💧', imageUrl: '/bebidas/agua-com-gas.png',      category: 'bebidas', active: true },
  { id: 'suco-manga',        name: 'Suco Del Valle Manga 290ml',         description: 'Suco Del Valle sabor Manga 290ml',                       price: 7.5,  image: '🧃', imageUrl: '/bebidas/suco-manga.png',        category: 'bebidas', active: true },
  { id: 'suco-uva',          name: 'Suco Del Valle Uva 290ml',           description: 'Suco Del Valle sabor Uva 290ml',                         price: 7.5,  image: '🧃', imageUrl: '/bebidas/suco-uva.png',          category: 'bebidas', active: true },
]
